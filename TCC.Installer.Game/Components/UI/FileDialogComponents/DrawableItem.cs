...
namespace TCC.Installer.Game.Components.UI.FileDialogComponents
{
    public class DrawableItem : Container, IHasFilterTerms
    {
        ...
        private readonly Color4 hoveredBackgroundColor = TCCColours.FromHex("404040");
        private readonly SpriteIcon icon;

        private readonly BindableBool selected = new BindableBool();
        private readonly Color4 selectedBackgroundColor = TCCColours.FromHex("606060");
        ...
        private Color4 selectedForegroundColor = TCCColours.FromHex("66ccff");
